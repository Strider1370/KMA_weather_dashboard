...
function StatusItem({ label, status }) {
  ...
  return (
    <div className="status-item">
      <span className="status-label">{label}</span>
      <span className="status-value">{status.last_updated ? formatUtc(status.last_updated) : "Unknown"}</span>
  ...
  return (
    <section className="panel">
      ...
      <div className="status-grid">
        <StatusItem label="METAR" status={status.metar} />
        <StatusItem label="TAF" status={status.taf} />
